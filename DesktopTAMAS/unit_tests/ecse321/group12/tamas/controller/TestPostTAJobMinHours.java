...
public class TestPostTAJobMinHours {
...
private boolean approval;
	...
	@Test
	public void testMinHoursInputs() {
		...
		try {
			...
			fail("No invalid input exception for null MinHours!");
			
		} catch (InvalidInputException e) {
			
			assertEquals("MinHours cannot be null!", e.getMessage());
		}
