...
public class TestRegisterApplicantIsGraduate {
...
private ResourceManager rm;
	...
	@Test
	public void testisGraduateInputs() {
		
		TamasController tc = new TamasController(rm);
		
		try {
			tc.registerApplicant(name, id, cGPA, skills, isGraduate);
			fail("No invalid input exception for null isGraduate!");
			
		} catch (InvalidInputException e) {
			
			assertEquals("isGraduate cannot be null!", e.getMessage());
		}
