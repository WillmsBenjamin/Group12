...
public class TestPostTAJobApproval {
...
private boolean approval;
	...
	@Test
	public void testapprovalInputs() {
		...
		try {
			...
			fail("No invalid input exception for null approval!");
			
		} catch (InvalidInputException e) {
			
			assertEquals("Approval cannot be null!", e.getMessage());
		}
