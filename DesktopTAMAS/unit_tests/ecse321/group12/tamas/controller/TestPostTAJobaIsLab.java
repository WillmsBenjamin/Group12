...
public class TestPostTAJobaIsLab {
...
private boolean approval;
	...
	public void testaIsLabInputs() {
		...
		try {
			...
			fail("No invalid input exception for null aIsLab!");
			
		} catch (InvalidInputException e) {
			
			assertEquals("aIsLab cannot be null!", e.getMessage());
		}
